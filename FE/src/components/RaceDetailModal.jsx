          ...
          {loading ? <p style={{ textAlign: "center", color: "#657086", fontSize: 14, padding: "40px 0" }}>Đang tải chi tiết cuộc đua...</p> : (
            <>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(140px,1fr))", gap: 12, marginBottom: 22 }}>
                <InfoTile icon={<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M21.3 15.3l-2.6 2.6a1 1 0 0 1-1.4 0l-12-12a1 1 0 0 1 0-1.4l2.6-2.6a1 1 0 0 1 1.4 0l12 12a1 1 0 0 1 0 1.4z" /><path d="M14.5 16.5l-2-2" /><path d="M11.5 13.5l-2-2" /><path d="M8.5 10.5l-2-2" /><path d="M17.5 19.5l-2-2" /></svg>} label="Khoảng cách" value={`${fmtNum(distance * Math.max(1, laps))}m`} />
